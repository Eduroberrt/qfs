    ...
    <section className="md:py-40 py-20" id="upgrade">
      <div className="container mx-auto lg:max-w-screen-xl px-4">
        <div className="grid lg:grid-cols-2 sm:gap-0 gap-10 items-center">
          <div>
            <p className="text-primary sm:text-28 text-18 mb-3">Secure Wallet</p>
            ...
            <p className="text-muted text-opacity-60 text-18 mb-7">
              Gain peace of mind by securing and managing 35+ coins, including XLM and Ethereum, plus all your tokens and NFTs. Oversee your collection, manage all your digital assets, and send your NFTs to another wallet with full transparency.
            </p>
