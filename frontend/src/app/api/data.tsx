...
export const footerlabels: { label: string; herf: string }[] = [
  { label: "Bounty Program", herf: "/redirect-to-dashboard" },
  { label: "Resellers", herf: "/redirect-to-dashboard" },
  { label: "Privacy Policy", herf: "/redirect-to-dashboard" },
  { label: "Our Vision", herf: "/redirect-to-dashboard" },
  { label: "Partners", herf: "/redirect-to-dashboard" },
  { label: "Cookie Policy", herf: "/redirect-to-dashboard" },
];
...
export const timelineData: {
...
}[] = [
  {
    ...
    title: "Buy",
    text: "Purchase cryptocurrencies instantly with secure payment methods",
    position: "md:top-0 md:left-0",
  },
  {
    icon: "/images/timeline/icon-refinement.svg",
    title: "Send",
    text: "Transfer crypto assets to friends and family worldwide",
    position: "md:top-0 md:right-0",
  },
  {
    icon: "/images/timeline/icon-prototype.svg",
    title: "Receive",
    text: "Accept crypto payments from anywhere in the world seamlessly",
    position: "md:bottom-0 md:left-0",
  },
  {
    icon: "/images/timeline/icon-support.svg",
    title: "Swap",
    text: "Exchange between different cryptocurrencies with competitive rates",
